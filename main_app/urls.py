...
urlpatterns = [
  ...
  path('product_detail/<int:product_id>/', views.products_detail, name='products_detail'),
  path('accounts/signup/', views.signup, name='signup'),
  path('product_detail/<int:product_id>/add_favorite/<int:user_id>', views.favorite_add, name='favorite_add'),
  path('product_detail/<int:product_id>/remove_favorite/<int:user_id>', views.favorite_remove, name='favorite_remove'),
